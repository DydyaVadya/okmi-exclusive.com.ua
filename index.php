...
})(window,document,'script','dataLayer','GTM-TXWNJ2D');</script>
<!-- End Google Tag Manager -->
    </head>
    <body>
    	<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TXWNJ2D"
                            ...
                            <div class="row">
                                ...
                                <div  class="video-block">
                                    ...
                                    <p class="video-description">
                                        ...
                                        <span>Лучший отель полуострова Пелопоннес</span>
                                        <span class='light-text'>Aldemar Olympian Village 5*</span>
                                    </p>
                                    <!-- <img src="img/video.jpg" alt="video"> -->
                                    <iframe class="iframe" width="100%" height="315" src="https://www.youtube.com/embed/qwngXJHeg0M?rel=0&amp;showinfo=0&amp;loop=1&amp;autoplay=1&amp;mute=1" frameborder="0" allow="autoplay; encrypted-media;" allowfullscreen></iframe>
                                </div>
                            </div>                            
                        </div>
                        <div class="col-md-5 col-sm-6 col-8">
                            <div class="row">
                                <div class="form-block">
                                    ...
                                    <button class="bright-btn" data-form="1" onClick="fbq('track', 'Lead');" >Оставить заявку</button>
                        ...
                        <div class="col-md-5 col-sm-6 col-8">
                            <div class="row">
                                <div class="form-block">
                                    ...
                                    <input class="input-style" type="text" placeholder="Ваше имя" name="name">
                                    <input class="input-style" type="text" placeholder="Ваш номер телефона" name="phone">
                                    <button class="bright-btn" data-form="2" onClick="fbq('track', 'Lead');">Оставить заявку</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="program__list scroll-style">
                                    ...
                                    <ol class="list-days list-fadeout">
                                        <li>Тренировка на все группы мышц - Full body в тренажерном зале Olympian Village. </li>
                                        <li>Функциональная тренировка с петлями TRX и еластичными резинками на свежем воздухе. </li>
                                        <li>Тренировка направлена на создание идеального пресса и здоровья спины.</li>
                                        <li>Тренировка для мышц ног (акцент на ягодицы).</li>
                                        <li class="hide">День восстановления - Relax day.</li>
                                        <li class="hide">Тренировка на вверх с елементами Kibo.</li>
                                        <li class="hide">Стато-динамическая тренировка, направленная на проработку всех мышечных групп.</li>
                                       <!--  <li class="hide">Relax day (восстановление). По желанию экскурсия: Пещеры Зевса или Кносский дворец, или Тайны православных святынь. Тренинг "Развитие эмоционального интеллекта - "Что растет в твоем саду". Чувства. Эмоции. Самовыражение. Взрослый мир чувств.</li>
                                        ...
                                        <li class="hide">Выселение из отеля. Трансфер в аэропорт. Вылет из Ираклиона в 07:40, прилетаем в Киев Борисполь в 10:25.</li> -->
                                    </ol>  
                                    </div>
...
<br>2. Просторанство имени меня.
Вы узнаете как вас воспринимают другие люди, какой образ у них скаладывается при общении с вами.</p>
                            </div>
                           <!--  <div class="col-sm-5 col-12">
                            ...
                            <div class="col-sm-5 col-12">
                                <div class="secendary-title">Мир мужчин!</div>
                                <p>3.Вы сможете лучше понять, рядом с каким мужчиной вы сможете чувствовать себя счастливой.
<br>4. Быть слабой женщиной, но опираться на себя!
Вы научитесь уступать мужчинам, уважая и принимая их мнение и строить гармоничные отношения НА РАВНЫХ!!!

<br>5. Женские штучки.
Вы узнаете почему женщины манипулируют и научитесь более приемлемым и действенным приемам влияния!</p>
                            </div>
                        </div>  
                    </div>
                </div>
                           ...
                           <div class="row">
                               <div class="form-block">
                                   ...
                                   <form class="send-form-3">
                                    <input class="input-style" type="text" placeholder="Ваше имя" name="name">
                                    <input class="input-style" type="text" placeholder="Ваш номер телефона" name="phone">
                                    <button class="bright-btn" data-form="3" onClick="fbq('track', 'Lead');">Оставить заявку</button>
                                   </form>
                                </div>
                            </div>
                       </div>
